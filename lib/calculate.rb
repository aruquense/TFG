class Calculate
  ...
  def self.test_pfeiffer(s01,s02,s03,s04,s05,s06,s07,s08,s09,s10,s11)
    s01.to_i+s02.to_i+s03.to_i+s04.to_i+s05.to_i+s06.to_i+s07.to_i+s08.to_i+s09.to_i+s10.to_i+s11.to_i
  end
