...
class DiagnosisTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis_type" do
    assert_difference('DiagnosisType.count') do
      post diagnosis_types_url, params: { diagnosis_type: { description: @diagnosis_type.description, description_en: @diagnosis_type.description_en, idn: @diagnosis_type.idn } }
    end
  ...
  test "should update diagnosis_type" do
    patch diagnosis_type_url(@diagnosis_type), params: { diagnosis_type: { description: @diagnosis_type.description, description_en: @diagnosis_type.description_en, idn: @diagnosis_type.idn } }
