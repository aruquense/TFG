...
class ProfessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profession" do
    assert_difference('Profession.count') do
      post professions_url, params: { profession: { description: @profession.description, description_EN: @profession.description_EN, erase: @profession.erase, idn: @profession.idn } }
    end
  ...
  test "should update profession" do
    patch profession_url(@profession), params: { profession: { description: @profession.description, description_EN: @profession.description_EN, erase: @profession.erase, idn: @profession.idn } }
