...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { description: @habit.description, description_EN: @habit.description_EN, idn: @habit.idn } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { description: @habit.description, description_EN: @habit.description_EN, idn: @habit.idn } }
